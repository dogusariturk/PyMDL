...
class _Element:
    ...
    atomic_weight : float
        Relative atomic weight [1]_
    atomic_radius : float
        Atomic radius in pm [2]_

    References
    ----------
    .. [1] IUPAC-CIAAW. Standard atomic weights.
    URL: http://www.ciaaw.org/atomic-weights.htm.

    .. [2] John C Slater. Atomic Radii in Crystals. The Journal of Chemical Physics, 41(10):3199, 1964.
    URL: http://scitation.aip.org/content/aip/journal/jcp/41/10/10.1063/1.1725697, doi:10.1063/1.1725697.
    """
...
_elements = {x: _Element(x, _element_data[x]["melting_point"], _element_data[x]["atomic_number"],
                         _element_data[x]["atomic_volume"], _element_data[x]["atomic_weight"],
                         _element_data[x]["atomic_radius"], _element_data[x]["nvalence"]) for x in _element_data}
